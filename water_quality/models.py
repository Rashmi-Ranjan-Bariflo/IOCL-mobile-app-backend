...
class WaterQualityReading(models.Model):
    ...
    parameter = models.ForeignKey(WaterQualityParameter, on_delete=models.CASCADE, related_name="readings")
    plant = models.ForeignKey(Plant, on_delete=models.CASCADE, related_name="water_quality_readings")
    plant_stage = models.ForeignKey(PlantStage,on_delete=models.SET_NULL,null=True,blank=True,related_name="water_quality_readings",)
    sensor = models.ForeignKey(Sensor,on_delete=models.SET_NULL,null=True,blank=True,related_name="water_quality_readings",)
